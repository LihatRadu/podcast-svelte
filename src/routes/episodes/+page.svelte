  <h1 class="text-4xl font-bold text-red-700">Episodes</h1>

<div class="py-16 space-y-4">
    
<article class="rounded-xl bg-yellow-400 p-4 ring ring-indigo-50 sm:p-6 lg:p-8 ">
  <div class="flex items-start sm:gap-8">
   <img src="../assets/johnny.jpg" alt="dollar" class="h-40 w-40 rounded-lg"> 
    ...
    <div>
      ...
      <h3 class="mt-4 text-lg font-medium sm:text-xl">
        <a href="#" class="hover:underline text-indigo-700"> Bob Bailey Diagnosed </a>
      </h3>
      ...
      <div class="mt-4 sm:flex sm:items-center sm:gap-2">
        ...
        <p class="mt-2 text-xs font-medium text-gray-500 sm:mt-0">
          Featuring <a href="#" class="underline hover:text-gray-700">Bob Bailey</a>,
  ...
  <!--Ep.2-->
<article class="rounded-xl p-4 bg-yellow-400 ring ring-indigo-50 sm:p-6 lg:p-8">
  <div class="flex items-start sm:gap-8">
   <img src="../assets/ep2.jpg" alt="ep2" class="h-40 w-40 rounded-lg"> 
    <div>
      <strong
        class="rounded border border-indigo-500 bg-indigo-500 px-3 py-1.5 text-[10px] font-medium text-white"
      >
      ...
      <h3 class="mt-4 text-lg font-medium sm:text-xl">
        <a href="#" class="hover:underline text-indigo-700"> Some Interesting Podcast Title </a>
      </h3>
